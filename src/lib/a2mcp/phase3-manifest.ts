...
export const PHASE3_TOOL_ENTRIES: ToolManifestEntry[] = [
  ...
  },
  {
    ...
    method: "POST",
    description: "Read-only scan/task status for a prior scan_repository call.",
    inputSchema: repoRefInput,
    outputSchema: actionOutputSchema,
    exampleRequest: { scanId: "scan_xyz" },
    exampleResponse: { success: true, taskId: "task_status", status: "completed", result: { status: "completed" } },
  },
  {
    name: "get_repository_coverage",
    endpoint: "/api/tools/get_repository_coverage",
    method: "POST",
    description: "Read-only analyzer coverage and risk-bucket counts for a scanned repository.",
    inputSchema: repoRefInput,
    outputSchema: actionOutputSchema,
    exampleRequest: { scanId: "scan_xyz" },
    exampleResponse: { success: true, taskId: "task_cov", status: "completed", result: {} },
  },
  {
    name: "list_findings",
    endpoint: "/api/tools/list_findings",
    method: "POST",
    description: "List structured findings for a completed scan (read-only).",
    inputSchema: repoRefInput,
    outputSchema: actionOutputSchema,
    exampleRequest: { scanId: "scan_xyz" },
    exampleResponse: { success: true, taskId: "task_list", status: "completed", result: { count: 0 } },
  },
  {
    name: "get_finding_evidence",
    endpoint: "/api/tools/get_finding_evidence",
    method: "POST",
    description: "Return evidence bundle for one finding id (read-only).",
    inputSchema: {
      ...repoRefInput,
      required: ["findingId"],
      properties: {
    ...
    outputSchema: actionOutputSchema,
    exampleRequest: { scanId: "scan_xyz", findingId: "f_1" },
    exampleResponse: { success: true, taskId: "task_ev", status: "completed", result: {} },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...repoRefInput.properties,
        excludeFindingIds: { type: "array", items: { type: "string" } },
      },
    },
    outputSchema: actionOutputSchema,
    exampleRequest: { scanId: "scan_xyz" },
    exampleResponse: { success: true, taskId: "task_plan", status: "completed", result: { planCount: 0 } },
  },
  {
    name: "get_plan_status",
    endpoint: "/api/tools/get_plan_status",
    method: "POST",
    description: "Read-only status lookup for a prepared cleanup plan.",
    inputSchema: {
      type: "object",
      properties: {
        ...repoRefInput.properties,
    ...
    outputSchema: actionOutputSchema,
    exampleRequest: { planId: "plan_abc" },
    exampleResponse: { success: true, taskId: "task_ps", status: "completed", result: {} },
  },
  {
    name: "get_delivery_status",
    endpoint: "/api/tools/get_delivery_status",
    method: "POST",
    description: "Read-only OKX A2A delivery status for a cleanup task.",
    inputSchema: {
      type: "object",
      properties: {
    ...
    outputSchema: actionOutputSchema,
    exampleRequest: { a2aTaskId: "a2a_abc" },
    exampleResponse: { success: true, taskId: "task_ds", status: "completed", result: {} },
  },
];
