...
export async function buildOkxHealthResponse() {
  ...
  return {
    ...
    githubAppReady: Boolean(marketplace.githubAppReady),
    githubAppReadyReason: marketplace.githubAppReadyReason ?? null,
    githubAppReadyMessage: marketplace.githubAppReadyMessage ?? null,
    receiptSignerReady: Boolean(marketplace.receiptSignerReady),
    receiptSignerReadyReason: marketplace.receiptSignerReadyReason ?? null,
    receiptSignerReadyMessage: marketplace.receiptSignerReadyMessage ?? null,
    attestationSignerReady: Boolean(marketplace.attestationSignerReady),
    attestationSignerReadyReason: marketplace.attestationSignerReadyReason ?? null,
    attestationSignerReadyMessage: marketplace.attestationSignerReadyMessage ?? null,
    activeWorkflowRuns: marketplace.activeWorkflowRuns ?? 0,
    lastSuccessfulWorkerRun: marketplace.lastSuccessfulWorkerRun ?? null,
