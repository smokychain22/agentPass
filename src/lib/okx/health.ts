...
export async function buildOkxHealthResponse() {
  ...
  return {
    ...
    // Exact field names from the OKX resubmission audit's production-health contract.
    agentId: agentRuntime.aspAgentId,
    lastHeartbeatAt: agentRuntime.lastSeenAt,
    a2mcpReady: Boolean(marketplace.a2mcpQuickTriageReady),
    a2aReady: a2aRuntimeReady,
    taskWatcherOnline: agentRuntime.officialWatchActive,
    xmtpConnected: agentRuntime.xmtpClientReady,
    reviewerRequestCount: agentRuntime.reviewerRequestCount,
    lastReviewerRequestAt: agentRuntime.lastReviewerRequestAt,
    lastReviewerResponseAt: agentRuntime.lastReviewerResponseAt,
    lastReviewerResponseLatencyMs: agentRuntime.lastReviewerResponseLatencyMs,
    samplingSupported: true,
    workerPid: agentRuntime.workerPid,
    duplicateWorkerCount: agentRuntime.duplicateWorkerAttemptCount,
