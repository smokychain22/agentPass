...
/** Compact explanation of live OKX services — ASP 9636. */
  ...
  return (
    <Panel variant="elevated" padding="md" className="text-sm text-muted-foreground">
      ...
      <dl className="space-y-2">
        <div>
          <dt className="font-medium text-foreground">A2MCP 37347 · Quick Triage</dt>
          <dd>
        ...
        <div>
          <dt className="font-medium text-foreground">A2A 37348 · Verified Cleanup PR</dt>
          <dd>
        ...
        <div>
          <dt className="font-medium text-foreground">ASP 9636</dt>
          <dd>
